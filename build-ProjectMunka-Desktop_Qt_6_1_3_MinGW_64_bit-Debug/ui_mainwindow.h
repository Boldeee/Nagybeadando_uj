...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        leptetbtn = new QPushButton(centralwidget);
        leptetbtn->setObjectName(QString::fromUtf8("leptetbtn"));
        QPalette palette;
        QBrush brush(QColor(240, 0, 4, 255));
        brush.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Button, brush);
        palette.setBrush(QPalette::Inactive, QPalette::Button, brush);
        palette.setBrush(QPalette::Disabled, QPalette::Button, brush);
        leptetbtn->setPalette(palette);
        leptetbtn->setAutoFillBackground(false);

        verticalLayout_3->addWidget(leptetbtn);
